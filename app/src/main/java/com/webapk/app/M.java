...
import android.webkit.*;import android.view.*;import android.graphics.Color;
public class M extends Activity{
  ...
  @Override protected void onCreate(Bundle b){
    ...
    w=new WebView(this);w.setBackgroundColor(Color.parseColor("#6366f1"));setContentView(w);
